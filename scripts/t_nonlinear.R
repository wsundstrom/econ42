...
# Description: Nonlinear regressions and replication of Table 8.1
...
qplot(avginc, testscr, data=caschool, 
      geom=c("point","smooth"), 
      method="lm", se=FALSE, 
      main = "Average income and district test score", 
      ylab = "Test Score",xlab = "Average income")
